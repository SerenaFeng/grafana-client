...
from grafana_client.yamlman.errors import YamlManException
from grafana_client.yamlman.formatter import deep_format
...
class YamlParser(object):
    ...
    def expandYaml(self, objs_glob=None):
        for obj in self.data.get('dashboard', {}).values():
